...
distinguished the sides — only a proxy for it — and, measured against onepipeline 0.29.0,
...
adoption, `oneagentgraph-cli` 0.4.0 is compiled against `oneharness-core` 0.13.0
...
> functions — are in neither `onepipeline` v0.29.0,
> `oneagentgraph` 0.4.0, nor `onevcs` 0.21.0. **Do not configure against them.** The
...
([onejudge v0.10.0 docs/protocol.md](https://github.com/nickderobertis/onejudge/blob/v0.10.0/docs/protocol.md)),
