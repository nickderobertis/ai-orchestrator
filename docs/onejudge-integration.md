...
distinguished the sides — only a proxy for it — and, measured against onepipeline 0.22.2,
...
> functions — are in neither `onepipeline` v0.22.2,
> `oneagentgraph` 0.3.15, nor `onevcs` 0.19.2. **Do not configure against them.** The
