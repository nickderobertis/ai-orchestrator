...
distinguished the sides — only a proxy for it — and, measured against onepipeline 0.39.0,
...
> functions — are in neither `onepipeline` v0.39.0,
> `oneagentgraph` 0.4.5, nor `onevcs` 0.25.0. **Do not configure against them.** The
