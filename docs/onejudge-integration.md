...
distinguished the sides — only a proxy for it — and, measured against onepipeline 0.10.1,
...
> functions — are in neither `onepipeline` v0.10.1,
> `oneagentgraph` 0.3.6, nor `onevcs` 0.10.0. **Do not configure against them.** The
