...
Three consequences, the first two re-measured against onepipeline 0.44.1 and the
...
oneagentgraph `onepipeline` links, which is `0.4.9` at onepipeline v0.44.1. Read that
