...
Three consequences, the first two re-measured against onepipeline 0.26.1 and the
...
oneagentgraph `onepipeline` links, which is `0.3.15` at onepipeline v0.26.1. Read that
