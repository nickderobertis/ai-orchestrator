...
Three consequences, the first two re-measured against onepipeline 0.14.2 and the
...
oneagentgraph `onepipeline` links, which is `0.3.10` at onepipeline v0.14.2. Read that
