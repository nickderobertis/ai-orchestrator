...
Three consequences, the first two re-measured against onepipeline 0.44.2 and the
...
oneagentgraph `onepipeline` links, which is `0.4.10` at onepipeline v0.44.2. Read that
