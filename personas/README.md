...
Three consequences, the first two re-measured against onepipeline 0.34.0 and the
...
oneagentgraph `onepipeline` links, which is `0.4.2` at onepipeline v0.34.0. Read that
