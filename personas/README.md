...
Three consequences, the first two re-measured against onepipeline 0.16.2 and the
...
oneagentgraph `onepipeline` links, which is `0.3.11` at onepipeline v0.16.2. Read that
