...
Three consequences, the first two re-measured against onepipeline 0.22.2 and the
...
oneagentgraph `onepipeline` links, which is `0.3.15` at onepipeline v0.22.2. Read that
