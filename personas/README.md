...
Three consequences, the first two re-measured against onepipeline 0.10.1 and the
...
oneagentgraph `onepipeline` links, which is `0.3.6` at onepipeline v0.10.1. Read that
