...
Three consequences, the first two re-measured against onepipeline 0.47.0 and the
...
oneagentgraph `onepipeline` links, which is `0.5.2` at onepipeline v0.47.0. Read that
