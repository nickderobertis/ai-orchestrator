...
Three consequences, the first two re-measured against onepipeline 0.27.2 and the
...
oneagentgraph `onepipeline` links, which is `0.3.17` at onepipeline v0.27.2. Read that
