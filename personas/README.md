...
Three consequences, the first two re-measured against onepipeline 0.29.3 and the
...
oneagentgraph `onepipeline` links, which is `0.4.1` at onepipeline v0.29.3. Read that
