...
Three consequences, the first two re-measured against onepipeline 0.14.0 and the
...
oneagentgraph `onepipeline` links, which is `0.3.9` at onepipeline v0.14.0. Read that
